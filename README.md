...
[![LinkedIn][linkedin-shield]](https://linkedin.com/in/trungdinh1983)
...
![Search Page](https://media.licdn.com/dms/image/D562DAQHWJLMj7d1g7g/profile-treasury-image-shrink_800_800/0/1691772323581?e=1698789600&v=beta&t=gTpraVYbBrzJeUVXUL51vagBj7KuRUTmRZkpY2whZmw)
...
2. Clone the repo
   ...
   ``` 
3. npm install npm@latest -g (BackEnd)
   ```sh
   npm install
   ```
3. npm install npm create vite@latest(Front End)
   ```sh
...
List features to be added and how you would implement.
